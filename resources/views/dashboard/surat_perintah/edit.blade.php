...
@section('container')
    <div class="container container-fluid mb-3 d-flex justify-content-center">
        <h2 class="h3 text-uppercase">Edit Surat</h2>
    </div>
    <div class="container container-fluid d-flex justify-content-center">
        <div class="col-md-8 ">
            <div class="portlet light bordered">
                    <div class="form-body">
                        <form action="/surat/{{ $surats->id }}" method="post">
                        @method('put')
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="pegawai_id">
                                @foreach($pegawais as $pegawai)
                                    @if(old('pegawai_id', $surats->pegawai_id) == $pegawai->id)
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="perjalanan_id">
                                @foreach($perjalanans as $perjalanan)
                                    @if(old('perjalanan_id',$surats->perjalanan_id) == $perjalanan->id)
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nomor')
                                is-invalid
                            @enderror" id="nomor" name="nomor" placeholder="Masukan Nomor SPPD..." autofocus required value="{{ old('nomor', $surats->nomor) }}">
                            @error('nomor')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input id="uraian" type="hidden" name="uraian" value="{{ old('uraian',$surats->uraian) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="status_id">
                                @foreach($statuses as $status)
                                    @if(old('status_id',$surats->status_id) == $status->id)
