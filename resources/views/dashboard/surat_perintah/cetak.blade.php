    ...
    <div class="container container-fluid">
        <table>
            ...
            <tr>
                <td></td>
                <td class="kanant"></td>
                <td class="kanant" style="font-weight: bold; padding-bottom: 10px;">Sekretaris </td>
            </tr>
        </table>
        ...
        <table>
            <tr>
                <td></td>
                <td class="kiri"></td>
                <td class="kiri" style="font-weight: bold; text-decoration: underline; font-size: 11">
                    <!-- Gambar tanda tangan -->
                    <img src="{{ asset('assets/images/ttd.jpg') }}" alt="ttd" style="width: 150px; height: auto; padding-top:-5;">
                </td>
            </tr>
            <tr>
                <td></td>
                ...
                <td class="kiri" style="font-weight: bold; text-decoration: underline; font-size: 11">
                    <!-- Nama sekretaris -->
                    H. IIK AHMAD RIFA'I, S.Ag, M.Si. <br>
                </td>
            </tr>
            <tr>
                <td></td>
