...
@section('container')
    <div class="container container-fluid mb-3 d-flex justify-content-center">
        <h2 class="h3 text-uppercase">Edit Data Perjalanan</h2>
    </div>
                    ...
                    <div class="form-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('lama_perjalanan')
                                is-invalid
                            @enderror" id="lama_perjalanan" name="lama_perjalanan" placeholder="Masukan Durasi Perjalanan..." autofocus required value="{{ old('lama_perjalanan', $perjalanans[0]->lama_perjalanan) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('anggaran')
                                is-invalid
                            @enderror" id="anggaran" name="anggaran" placeholder="Masukkan Anggaran..." autofocus required value="{{ old('anggaran') }}">
                            @error('anggaran')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
